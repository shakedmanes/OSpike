...
function generateEnvFile(nodeEnv, port, hostname, mongoUrl, dbUsername, dbPassword, hostValidation, apmServiceName, apmServerUrl, apmSecretToken) {
...
generateEnvFile(env, port, hostname, mongoUrl, username, password, hostValidation, apmServiceName, apmServerUrl, apmSecretToken);